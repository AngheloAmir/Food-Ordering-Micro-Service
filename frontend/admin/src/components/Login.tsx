...
import { IconDeviceDesktopAnalytics, IconLock } from '@tabler/icons-react';
                ...
                <div className="bg-white dark:bg-stone-900 border-x-4 border-b-4 border-t-4 border-stone-300 dark:border-stone-800 shadow-xl p-8 relative overflow-hidden">
                    ...
                    <Stack gap="lg">
                        <div className="text-center mb-4">
                            <Center mb="md">
                                <div className="p-4 bg-stone-100 dark:bg-stone-800 rounded-full border-2 border-stone-200 dark:border-stone-700">
                                    <IconDeviceDesktopAnalytics size={42} className="text-stone-700 dark:text-stone-300" stroke={1.5} />
                                </div>
                            </Center>
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
                            <Stack>
                                <TextInput
                                    label={<Text size="sm" ff="monospace" fw={700} className="uppercase text-stone-500">Admin ID</Text>}
                                ...
                                <PasswordInput
                                    label={<Text size="sm" ff="monospace" fw={700} className="uppercase text-stone-500">Security Key</Text>}
